...
void registertoproxyhandler(RTSPServer* rtspServer, unsigned requestId, int resultCode, char* resultString) {
...
::implementCmd_REGISTER(char const* cmd/*"REGISTER" or "DEREGISTER"*/,
  ...
  if (strcmp(cmd, "REGISTER") == 0) {
	...
	registerStream(sms,(const char*)CLOUD_IP,8000,(responseHandlerForREGISTER *)registertoproxyhandler,NULL,NULL,True,(const char*)proxyURLSuffix);
